...
const createprActionTemplate = (ctx: any) => `name: 'Create Pull Request'
...
export const generate = (ctx: PinionContext) =>
  Promise.resolve(ctx)
    .then(renderTemplate(createprActionTemplate, toFile('.github/actions/job._createpr/action.yml')))