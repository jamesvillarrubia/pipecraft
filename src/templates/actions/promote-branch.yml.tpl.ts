      ...
      steps:
        ...
        - name: Create Pull Request
          ...
          run: |
            ...
            # Create PR body using cat with HEREDOC
            BODY=\$(cat <<EOF
            Automated release promotion from **\$SOURCE** to **\$TARGET**
            ...
            ## What's Next?
            This PR will \$MERGE_TEXT before promoting to \$TARGET.

            ---
            🤖 Generated by [PipeCraft](https://github.com/jamesvillarrubia/pipecraft)
            EOF
            )
