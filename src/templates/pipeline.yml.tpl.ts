...
// Template for the main Trunkflow Pipeline based on the original pipe.yml structure
const pipelineWorkflowTemplate = (ctx: any) => `name: Test and Deploy
...
export const generate = (ctx: PinionContext) =>
  Promise.resolve(ctx)
    .then(renderTemplate(pipelineWorkflowTemplate, toFile('.github/workflows/pipeline.yml')))